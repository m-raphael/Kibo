...
export { ACCESSORY_LIST } from './3d/accessories/index.js'
export type { AccessoryId, AccessoryMeta } from './3d/accessories/index.js'
export { PALETTE_LIST } from './3d/palettes/index.js'
export type { PaletteId, Palette } from './3d/palettes/index.js'
